        ...
        <div className="center">
          <div className="testimonial__grid">
            ...
            <div className="testimonial__text">
              ...
              home and I love how competitive they're interest rate are compared
              to other banks. they're the easiest and highest saving account we
              have."
              <p
                style={{ fontWeight: "bold", color: "blue", marginTop: "1rem" }}
              >
